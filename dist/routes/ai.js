...
import { reviewSubmissionRequestSchema, generateTaskRequestSchema, scoreWorkerSkillsRequestSchema, disputeSummaryRequestSchema, } from "../shared/index.js";
import { getSupabase } from "../lib/supabase.js";
import { reviewSubmissionWithAI, generateTaskWithAI, generateDisputeSummary, scoreWorkerSkills, } from "../services/openai.js";
...
aiRouter.post("/dispute-summary", async (req, res) => {
    try {
        ...
        const message = err instanceof Error ? err.message : "Dispute summary failed";
        res.status(400).json({ error: message });
    }
});
